...
export class TbAsignacionesComponent {
  ...
  this.treeunidadsYDireccion =   nodo.map((x: any) => this.convertirTreeNodeUnidadYDireccion(x));
  ...
  private convertirTreeNodeUnidad(
    ...
    const esHoja = (nodo.unidad_tipo === 5 || nodo.unidad_tipo === 4
      || nodo.unidad_tipo === 6 || nodo.unidad_tipo === 7
      || nodo.unidad_tipo === 11 || nodo.idunidad === 62) ? true : false // nodo.hijos.length === 0;
  ...
  private convertirTreeNodeUnidadYDireccion(
    nodo: any
  ): any {

    const esHoja = (nodo.unidad_tipo !== 10) ? true : false // nodo.hijos.length === 0;
    ...
    return {
      ...
      children: nodo.hijos.map((h: any) =>
        this.convertirTreeNodeUnidadYDireccion(h)
      )
  ...
  private convertirTreeNodeUnidadDirecciones(
    ...
    const esHoja = (nodo.unidad_tipo === 1 || nodo.unidad_tipo === 8 || nodo.unidad_tipo === 12 || nodo.unidad_tipo === 13
      || nodo.unidad_tipo === 14 || nodo.unidad_tipo === 3 || nodo.unidad_tipo === 9  || nodo.unidad_tipo === 5 || nodo.unidad_tipo === 6
      || nodo.unidad_tipo === 4
