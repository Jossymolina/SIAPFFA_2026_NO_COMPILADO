...
export class CrearPuestosComponent {
esperar= false;
  agregarNuevoCupo = {
...
this._ServiciosMensajeService.hide()
this._ServiciosMensajeService.mensajeMalo("ERROR DE CONECCION AL SACAR UNIDADES")
    }
  }
    )
  }
...
guardarPuesto() {
  ...
  if (!Number.isFinite(orden) || orden < 0) {
    this._DatospersonalesService.mensajeError('El orden jerárquico debe ser un número válido (0 o mayor).');
    return;
  }
